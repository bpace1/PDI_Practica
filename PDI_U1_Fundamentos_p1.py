...
# --- Leo imagen --------------------------------------------------
img = cv2.imread('U1/xray-chest.png',cv2.IMREAD_GRAYSCALE)  # https://opencv24-python-tutorials.readthedocs.io/en/latest/py_tutorials/py_gui/py_image_display/py_image_display.html
img = cv2.imread('U1/xray-chest.png')
...
img = cv2.imread('U1/cameraman.tif',cv2.IMREAD_GRAYSCALE)
h = plt.imshow(img, cmap='gray')
plt.colorbar(h)
plt.show()

cv2.imwrite("U1/cameraman90.jpeg", img, [cv2.IMWRITE_JPEG_QUALITY, 90])
cv2.imwrite("U1/cameraman50.jpeg", img, [cv2.IMWRITE_JPEG_QUALITY, 50])
cv2.imwrite("U1/cameraman25.jpeg", img, [cv2.IMWRITE_JPEG_QUALITY, 25])
cv2.imwrite("U1/cameraman10.jpeg", img, [cv2.IMWRITE_JPEG_QUALITY, 10])
cv2.imwrite("U1/cameraman05.jpeg", img, [cv2.IMWRITE_JPEG_QUALITY, 5])

# --- Metricas de error ----------------------------------------------------------------------------
img90 = cv2.imread('U1/cameraman90.jpeg',cv2.IMREAD_GRAYSCALE)
img05 = cv2.imread('U1/cameraman05.jpeg',cv2.IMREAD_GRAYSCALE)
...
image= Image.open('U1/cameraman.tif')
